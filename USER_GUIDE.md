...
When you open Gentle Companion for the first time, you'll move through a short 5-step onboarding:
...
Each day starts with a gentle check-in on the Home screen:
...
### ✨ Daily Micro-Plan (`/plan`)

Three small, manageable tasks are suggested each day from a curated library.
...
### 🌸 Glimmer Catcher (`/glimmers`)

Log anything that felt even slightly okay — a warm drink, a moment of quiet, a kind thought. One sentence is enough.
...
### 🧶 Thought Untangler (`/reflect`)

A 4-step guided CBT reframing tool to gently work through difficult thoughts:
...
### 🌬️ Soothing Toolkit (`/toolkit`)

Three grounding exercises for difficult moments:
...
A passive, judgment-free look at your week:
...
### 💌 Letter to Myself (`/letter`)

Write a compassionate note to yourself on a stable day. On low-energy days (energy ≤ 3), the app gently surfaces this letter on the Home screen.
...
- **Nothing leaves your device.** All data is stored in your browser's localStorage only.
...
Gentle Companion is a supportive tool, not a medical device or a substitute for professional mental health care. If you are in crisis, please use the **💙 Crisis Button** to reach real human support.
